...
public class EfficiencyUpgradeT2Item extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:efficiency_upgrade_t_2")
	public static final Item block = null;

	public EfficiencyUpgradeT2Item(EnergioomModElements instance) {
		super(instance, 50);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("efficiency_upgrade_t_2");
		}
