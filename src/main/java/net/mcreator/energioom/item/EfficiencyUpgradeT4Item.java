...
public class EfficiencyUpgradeT4Item extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:efficiency_upgrade_t_4")
	public static final Item block = null;

	public EfficiencyUpgradeT4Item(EnergioomModElements instance) {
		super(instance, 56);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("efficiency_upgrade_t_4");
		}
