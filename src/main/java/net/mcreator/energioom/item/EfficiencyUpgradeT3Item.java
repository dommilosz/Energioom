...
public class EfficiencyUpgradeT3Item extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:efficiency_upgrade_t_3")
	public static final Item block = null;

	public EfficiencyUpgradeT3Item(EnergioomModElements instance) {
		super(instance, 51);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("efficiency_upgrade_t_3");
		}
