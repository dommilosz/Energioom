...
public class EnergioomShardRefinedItem extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:energioom_shard_refined")
	public static final Item block = null;

	public EnergioomShardRefinedItem(EnergioomModElements instance) {
		super(instance, 33);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("energioom_shard_refined");
		}
