...
public class SpeedUpgradeT4Item extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:speed_upgrade_t_4")
	public static final Item block = null;

	public SpeedUpgradeT4Item(EnergioomModElements instance) {
		super(instance, 55);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("speed_upgrade_t_4");
		}
