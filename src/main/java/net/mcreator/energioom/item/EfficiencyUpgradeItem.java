...
public class EfficiencyUpgradeItem extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:efficiency_upgrade")
	public static final Item block = null;

	public EfficiencyUpgradeItem(EnergioomModElements instance) {
		super(instance, 43);
	}
