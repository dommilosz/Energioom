...
public class BaseUpgradeT2Item extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:base_upgrade_t_2")
	public static final Item block = null;

	public BaseUpgradeT2Item(EnergioomModElements instance) {
		super(instance, 48);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("base_upgrade_t_2");
		}
