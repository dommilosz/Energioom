...
public class BaseUpgradeT3Item extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:base_upgrade_t_3")
	public static final Item block = null;

	public BaseUpgradeT3Item(EnergioomModElements instance) {
		super(instance, 53);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("base_upgrade_t_3");
		}
