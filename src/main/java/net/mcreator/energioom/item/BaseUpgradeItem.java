...
public class BaseUpgradeItem extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:base_upgrade")
	public static final Item block = null;

	public BaseUpgradeItem(EnergioomModElements instance) {
		super(instance, 41);
	}
