...
public class BatteryGUIGui extends EnergioomModElements.ModElement {
    public static HashMap guistate = new HashMap();
    private static ContainerType<GuiContainerMod> containerType = null;

    public BatteryGUIGui(EnergioomModElements instance) {
        super(instance, 10);
    ...
    public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
        ...
        private static final ResourceLocation texture = new ResourceLocation("energioom:textures/battery_gui.png");
