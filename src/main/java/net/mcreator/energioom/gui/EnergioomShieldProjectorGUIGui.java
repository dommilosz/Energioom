...
public class EnergioomShieldProjectorGUIGui extends EnergioomModElements.ModElement {
	...
	public EnergioomShieldProjectorGUIGui(EnergioomModElements instance) {
		super(instance, 72);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("energioom_shield_projector_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, EnergioomShieldProjectorGUIGuiWindow::new));
	}
