...
public class ItemEnergioomnisatorGUIGui extends EnergioomModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public ItemEnergioomnisatorGUIGui(EnergioomModElements instance) {
		super(instance, 6);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("item_energioomnisator_gui"));
	}
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 77, 35) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(EnergioomCrystalItem.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			int si;
			int sj;
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("energioom:textures/item_energioomnisator_gui.png");
