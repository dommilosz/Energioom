...
import net.mcreator.energioom.procedures.EnergioomDoorsUpdateTickProcedure;
...
public class EnergioomDoorsBlock extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:energioom_doors")
	public static final Block block = null;
	@ObjectHolder("energioom:energioom_doors")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public EnergioomDoorsBlock(EnergioomModElements instance) {
		super(instance, 25);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("energioom_doors"));
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1200f, 2400f).setLightLevel(s -> 0).notSolid());
			setRegistryName("energioom_doors");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				EnergioomDoorsUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(pos, this, 10);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("energioom_doors");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Energioom Doors");
		}
