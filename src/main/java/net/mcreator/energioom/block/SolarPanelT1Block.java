...
import net.mcreator.energioom.procedures.SolarPanelT1UpdateTickProcedure;
...
public class SolarPanelT1Block extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:solar_panel_t_1")
	public static final Block block = null;
	@ObjectHolder("energioom:solar_panel_t_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public static final BooleanProperty ENABLED = BlockStateProperties.ENABLED;
	public SolarPanelT1Block(EnergioomModElements instance) {
		super(instance, 14);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("solar_panel_t_1"));
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SolarPanelT1UpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(pos, this, 10);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("solar_panel_t_1");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Solar Panel T 1");
		}
