...
import net.mcreator.energioom.procedures.CreativePowerGeneratorUpdateTickProcedure;
...
public class CreativePowerGeneratorBlock extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:creative_power_generator")
	public static final Block block = null;

	public CreativePowerGeneratorBlock(EnergioomModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("creative_power_generator");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			CreativePowerGeneratorUpdateTickProcedure.executeProcedure(Stream
