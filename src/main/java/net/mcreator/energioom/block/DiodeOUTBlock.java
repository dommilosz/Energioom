...
public class DiodeOUTBlock extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:diode_out")
	public static final Block block = null;
	@ObjectHolder("energioom:diode_out")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public DiodeOUTBlock(EnergioomModElements instance) {
		super(instance, 8);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("diode_out"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("diode_out");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Diode OUT");
		}
