...
import net.mcreator.energioom.procedures.DiodeINUpdateTickProcedure;
...
public class DiodeINBlock extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:diode_in")
	public static final Block block = null;
	@ObjectHolder("energioom:diode_in")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public DiodeINBlock(EnergioomModElements instance) {
		super(instance, 7);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("diode_in"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			DiodeINUpdateTickProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("diode_in");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Diode IN");
		}
