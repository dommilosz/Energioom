...
public class EnergioomGlassBlock extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:energioom_glass")
	public static final Block block = null;

	public EnergioomGlassBlock(EnergioomModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("energioom_glass");
		}
