...
public class EnergioomStoneBlock extends EnergioomModElements.ModElement {
	@ObjectHolder("energioom:energioom_stone")
	public static final Block block = null;

	public EnergioomStoneBlock(EnergioomModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(35f, 1200f).setLightLevel(s -> 0)
					.harvestLevel(3).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("energioom_stone");
		}
