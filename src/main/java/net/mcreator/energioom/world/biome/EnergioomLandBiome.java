...
package net.mcreator.energioom.world.biome;
...
import net.mcreator.energioom.block.EnergioomStoneBlock;
import net.mcreator.energioom.block.EnergioomInfusedGrassBlock;
import net.mcreator.energioom.EnergioomModElements;

import com.google.common.collect.ImmutableList;

@EnergioomModElements.ModElement.Tag
public class EnergioomLandBiome extends EnergioomModElements.ModElement {
	public static Biome biome;

	public EnergioomLandBiome(EnergioomModElements instance) {
		super(instance, 21);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16711681).setWaterColor(-16711936).setWaterFogColor(-16711936)
						.withSkyColor(-16711681).withFoliageColor(-16711681).withGrassColor(-16711681).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(EnergioomInfusedGrassBlock.block.getDefaultState(),
								EnergioomStoneBlock.block.getDefaultState(), EnergioomStoneBlock.block.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(Blocks.GRAVEL.getDefaultState(), FeatureSpread.func_242253_a(2, 3), 2,
										ImmutableList.of(EnergioomInfusedGrassBlock.block.getDefaultState(),
												EnergioomStoneBlock.block.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("energioom:energioom_land"));
			}
		}
	}
